 ...
 * índice dos autos (Prioridade 2.5), evitando duas implementações da mesma coisa.
 */
      ...
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            individual — os autos ficam pendentes de sincronizar, sem repaginar na hora.
          </DialogDescription>
        </DialogHeader>
            ...
            <div key={v.id} className="rounded-md border border-border p-3">
              <div className="flex flex-wrap items-center justify-between gap-2">
                <p className="text-sm font-medium">
                  Versão {listaVersoes.length - i} — {new Date(v.criadoEm).toLocaleString("pt-BR")}
                </p>
                <Button
                  variant="outline"
                  size="sm"
