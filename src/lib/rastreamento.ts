 ...
 * requisições (o Supabase guarda sindicâncias/peças, mas não um log detalhado de cada
 * chamada — gravar isso a cada operação destruiria o próprio objetivo da Prioridade 1 de
 * reduzir gravações). Em vez de tentar persistir um log no servidor, cada operação instrumentada mede o tempo de suas próprias
